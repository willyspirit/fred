...
let userID = "0264f495-029d-410d-a783-3e6e81991cae";

const proxyIPs = ["proxyip.fxxk.dedyn.io"]; //ts.hpc.tw edgetunnel.anycast.eu.org bestproxy.onecf.eu.org cdn-all.xn--b6gac.eu.org cdn.xn--b6gac.eu.org proxy.xxxxxxxx.tk
const cn_hostnames = [''];
